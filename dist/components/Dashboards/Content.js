...
var Content = function (_a) {
    ...
    return react_1.default.createElement("main", { id: id, className: (className !== null && className !== void 0 ? className : 'storybook-dashboards-content') + " " + appendClassname }, children);
};
