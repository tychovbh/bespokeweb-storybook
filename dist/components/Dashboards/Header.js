...
var Header = function (_a) {
    ...
    return react_1.default.createElement("header", { id: id, className: (className !== null && className !== void 0 ? className : 'storybook-dashboards-header') + " " + appendClassname }, children);
};
