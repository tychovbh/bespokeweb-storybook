...
var Container = function (_a) {
    ...
    return react_1.default.createElement("div", { id: id, className: (className !== null && className !== void 0 ? className : 'storybook-modals-container') + " " + appendClassname }, children);
};
