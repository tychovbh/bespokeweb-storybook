...
import {classNames} from 'bespokeweb-storybook/helpers'
            ...
            {days.map((day) => {
                ...
                >
                    ...
                    <Calendars.Events.List>
                        {
                            day.events.map((event) => {
                                return <Calendars.Events.Item appendClassName={'lg:hidden'}>
                                    <Calendars.Events.Label>
                                        {event.name}
                                    </Calendars.Events.Label>
...

                        {
                            day.events.slice(0, 2).map((event) => {
                                return <Calendars.Events.Item appendClassName={'hidden lg:flex'}>
                                    <Calendars.Events.Label>
                                        {event.name}
                                    </Calendars.Events.Label>
